<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?php __DIR__ . '/' ?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="layout-top-navigation.html">Home Kategori</a></li>
                    <li><a class="nav-link" href="layout-default.html">Tambah Kategori</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-utensils"></i><span>Menu</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="layout-top-navigation.html">Home Menu</a></li>
                    <li><a class="nav-link" href="layout-default.html">Tambah Menu</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="layout-top-navigation.html">Home Pesanan</a></li>
                    <li><a class="nav-link" href="layout-default.html">Tambah Pesanan</a></li>
                </ul>
            </li>
